...
import com.example.wizard.GameFramework.utilities.FlashSurfaceView;

public class WizardSurfaceView extends FlashSurfaceView {
    //Tag for logging
    private static final String TAG = "WizardSurfaceView";
    ...
    /**
     * Constructor for the WizardSurfaceView class.
     *
     * @param context - a reference to the activity this animation is run under
     */
    public WizardSurfaceView(Context context) {
        super(context);
        init();
    }// ctor
     ...
     */
    public WizardSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }// ctor
    ...
    public void onDraw(Canvas g) {
        ...
        // paint the Wizard-board's horizontal and vertical lines
        Paint p = new Paint();
