...
public class WizardSurfaceViewFlipped extends WizardSurfaceView {
    //Tag for logging
    private static final String TAG = "WizardSurfaceViewFlipped";
    /*
     * Instance variables
     */
     ...
     */
    public WizardSurfaceViewFlipped(Context context) {
        super(context);
    }// ctor
     ...
     */
    public WizardSurfaceViewFlipped(Context context, AttributeSet attrs) {
        super(context, attrs);
    }// ctor
